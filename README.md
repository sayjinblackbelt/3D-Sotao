...
### **[▶ Abrir o Sótão 3D](https://sayjinblackbelt.github.io/3D-Sotao/)**
...
## 1. O que é o Sótão 3D

O **Sótão 3D** é uma operação de fabricação digital focada principalmente em **criações autorais, personalizadas e sob encomenda**.
...
Uma peça funcional e personalizada desenvolvida para receber um controle de PS5, combinando suporte e estética inspirada em máscara samurai.

**Tipo:** encomenda personalizada  
**Aplicação:** suporte funcional  
...
## 5. Sótão 3D × NEXA Studio

O Sótão 3D faz parte de um ecossistema criativo com a **NEXA Studio**, mas as duas frentes possuem funções próprias.
...
1. Manter PLA como material principal enquanto atende às necessidades atuais.
2. Validar modelos antes de produções longas quando o projeto exigir.
3. Registrar tempo, peso e falhas para formar uma base real de custos.
4. Priorizar peças com boa relação entre tempo, material, qualidade e valor percebido.
5. Utilizar acabamento quando ele agregar valor à encomenda.
6. Evitar expansão de equipamentos sem dados que justifiquem aumento de capacidade.

---

## 9. Estratégia comercial

### Prioridade 1 — Encomendas personalizadas

**ideia → conversa → orçamento → aprovação → produção → acabamento → entrega**

### Prioridade 2 — Criações autorais

Desenvolver peças próprias que possam ser apresentadas como portfólio, inspiração ou produtos de catálogo.

### Prioridade 3 — Catálogo

Organizar peças e linhas de criação sem transformar estoque em obrigação. Produtos com demanda comprovada podem evoluir para catálogo recorrente.

### Prioridade 4 — Canais

Estruturar progressivamente presença digital e canais de venda conforme capacidade operacional e demanda real.
...
- modelos encaminhados para produção;
- protótipos;
- produtos validados;
- versões por projeto.
...
Dados financeiros sensíveis devem permanecer no controle privado. O repositório público utiliza, quando necessário, indicadores agregados, faixas e percentuais.
...
- [`docs/PRODUTOS-PROPRIOS.md`](docs/PRODUTOS-PROPRIOS.md)
- [`docs/LINHAS-DE-PRODUTOS.md`](docs/LINHAS-DE-PRODUTOS.md)
- [`docs/LOG-PRODUCAO.md`](docs/LOG-PRODUCAO.md)

### Custos e comercial

- [`docs/FICHA-CUSTO-PRECIFICACAO.md`](docs/FICHA-CUSTO-PRECIFICACAO.md)
- [`docs/ESTOQUE-E-COMERCIAL.md`](docs/ESTOQUE-E-COMERCIAL.md)
- [`docs/DASHBOARD-E-ESCALA.md`](docs/DASHBOARD-E-ESCALA.md)

### Ecossistema

- [`docs/FLUXO-NEXA-STUDIO-SOTAO-3D.md`](docs/FLUXO-NEXA-STUDIO-SOTAO-3D.md)
...
- consolidar a homepage pública;
- validar visualmente o GitHub Pages;
- estruturar portfólio de encomendas reais;
- registrar fotografias e informações dos trabalhos entregues;
- organizar inventário e custos reais;
- estruturar canal de recebimento de encomendas.

### Próxima fase

- catálogo de criações;
- identidade comercial consolidada;
- presença em canais digitais;
- medição de conversão e ticket;
- identificação dos produtos e tipos de encomenda com maior demanda.

### Escala

- aumentar capacidade somente quando os dados justificarem;
- avaliar novos equipamentos e materiais por necessidade real;
- ampliar produtos próprios;
- fortalecer o ciclo NEXA Studio → Sótão 3D → mercado → NEXA Studio.

---

## 14. Princípio do negócio

> **Não queremos apenas imprimir objetos. Queremos transformar ideias em coisas que possam existir.**

O Sótão 3D existe para aproximar imaginação e matéria.
...
**Site público:** [Sótão 3D — GitHub Pages](https://sayjinblackbelt.github.io/3D-Sotao/)

**Ecossistema:** NEXA Studio → Sótão 3D.
